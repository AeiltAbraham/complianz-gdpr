...
const ThemeToggle = () => {
	...
	const labels = {
		/* translators: accessible label for theme toggle in light mode */
		light: __('Light mode', 'complianz-gdpr'),
		/* translators: accessible label for theme toggle in dark mode */
		dark: __('Dark mode', 'complianz-gdpr'),
		/* translators: accessible label for theme toggle in system mode */
